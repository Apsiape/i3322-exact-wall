KILL-PROVENANCE STAMP (2026-08-07): faithful copy retained as
provenance for the carried kill declarations (ledger entries 1-3).
NOT consumed by the U1G live chain; moved out of dependencies/ so
that directory contains consumed sources only (ledger entry 19).
